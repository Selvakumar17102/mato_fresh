...
<head>
	...
	<!-- DESCRIPTION -->
	<meta name="description" content="All Orders | Mato Fresh" />
	
	<!-- OG -->
	<meta property="og:title" content="All Orders | Mato Fresh" />
	<meta property="og:description" content="All Orders | Mato Fresh />
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>All Orders | Mato Fresh</title>
		...
		<div class="container-fluid">
			<div class="row">
						...
						<?php 
							...
							if($rhead["control"] == 0 || $rhead["control"] == 1)
							{
								$sql = "SELECT * FROM order_details WHERE order_status != 'Cancel' AND payment_status != 'Pending' AND payment_status IS NOT NULL ORDER BY sno DESC";
							}
							else
							{
								$sql = "SELECT * FROM order_details where order_status != 'Placed' AND payment_status != '' AND latitude='$hotelid' ORDER BY sno DESC";
							}
