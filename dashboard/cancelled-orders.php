...
<head>
	...
	<!-- DESCRIPTION -->
	<meta name="description" content="Cancelled Orders | Mato Fresh" />
	
	<!-- OG -->
	<meta property="og:title" content="Cancelled Orders | Mato Fresh" />
	<meta property="og:description" content="Cancelled Orders | Mato Fresh />
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Cancelled Orders | Mato Fresh</title>
		...
		<div class="container-fluid">
			<div class="row">
						...
						<?php 
							...
							if($rhead["control"] == 0)
							{
								$sql = "SELECT * FROM order_details where order_status = 'Cancelled' OR payment_status = 'Cancelled' ORDER BY sno DESC";
							}
							else
							{
								$sql = "SELECT * FROM order_details where order_status = 'Cancelled' OR payment_status = 'Cancelled' AND latitude='$hotelid' ORDER BY sno DESC";
							}
