...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Branch Reports | Mato Fresh</title>
									...
									<tbody>
                                        <?php
                                            ...
                                            while($row = $result->fetch_assoc())
                                            {
                                                ...
                                                $sql1 = "SELECT * FROM order_details WHERE latitude='$hid' AND product_id ='3' AND booking_date BETWEEN '$start' AND '$date'";
                                                ...
                                                $sql2 = "SELECT * FROM hotel WHERE lid='$hid'";
                                        ...
                                        ?>
													<tr>
														...
														<td><center><a href="hotel-report.php?ids=<?php echo $hid ?>"><?php echo $row2["name"] ?></a></center></td>
														<td><center><?php echo $ord ?></center></td>
														<td><center>Rs <?php echo number_format($amo) ?></center></td>
														<td><center>Rs <?php echo number_format($c) ?></center></td>
														<td><center>Rs <?php echo number_format($o) ?></center></td>
													</tr>
                                        <?php
												}
                                            }
...
<script>
	function boss(val)
	{
		if(val != "")
		{
			location.replace("https://matofresh.in/dashboard/report-hotel.php?id="+val);
		}
	}
	function search()
	{
		...
		else
		{
			...
			{
				location.replace("https://matofresh.in/dashboard/report-hotel.php?fdate="+fdate+"&tdate="+tdate);
			}
		}
	}
</script>
