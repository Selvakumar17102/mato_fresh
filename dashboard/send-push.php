<?php
	...
	if($sno != "")
	{
        ...
        header("Location: send-push.php?msg=Notification has been Sent Successfully!");
        
        $sql = "SELECT * FROM users WHERE fcm_token != ''";
        $result = $conn->query($sql);
    ...
    $sql1 = "INSERT INTO push_notification (title,image,message) VALUES ('$title','$image','$message')";
...
<head>
	...
	<!-- DESCRIPTION -->
	<meta name="description" content="Send Push Notification | Food Call" />
	
	<!-- OG -->
	<meta property="og:title" content="Send Push Notification | Food Call" />
	<meta property="og:description" content="Send Push Notification | Food Call" />
                            ...
                            <div class="table-responsive">
                    	        <table id="dataTableExample1" class="table table-striped">
									...
									<tbody>
										...
										<?php
											$sql = "SELECT * FROM push_notification ORDER BY sno DESC";
											$result = $conn->query($sql);
											$count = 1;
											while($row = $result->fetch_assoc())
											{
											...
											<tr>
												...
												<td><center><a onClick="return confirm('Sure to Send this Notification!');" href="send-push.php?id=<?php echo $row["sno"] ?>"><i class="fa fa-refresh" aria-hidden="true" style="background: green;color: #fff;padding: 11px;"></i></a></center></td>
												<td><center><a onClick="return confirm('Sure to Delete this Notification!');" href="delete-push.php?id=<?php echo $row["sno"] ?>"><img src="assets/images/icons/delete.svg" alt=""></a></center></td>
											</tr>
										<?php
											}
										?>
