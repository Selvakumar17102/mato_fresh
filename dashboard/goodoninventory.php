<?php
   ...
   if(isset($_POST['submit'])){
        ...
        while($row = $result->fetch_assoc()){
			...
			$checkSql = "SELECT * FROM goodon_inventory WHERE date='$date' AND product_id='$proId'";
			...
			if($checkResult->num_rows > 0){
				...
				$updateSql = "UPDATE goodon_inventory SET master_quentity='$mquentity', available_quentity='$mquentity' WHERE date='$date' AND product_id='$proId'";
				...
				$insertsql = "INSERT INTO goodon_inventory (date,product_id,master_quentity,available_quentity) VALUES('$date','$proId','$mquentity','$mquentity')";
		...
		if($insertResult === TRUE){
			header("location:goodoninventory.php?msg=Inventory Added Successfully.");
		}

		if($updateResult === TRUE){
			header("location:goodoninventory.php?msg=Inventory updated Successfully.");
		}
...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Goodon Inventory | Mato Fresh</title>
				...
				<div class="col-lg-12">
					...
					<div class="widget-box">
						<div class="card-header">
							<div class="row">
                        	<div class="col-md-10">
								<h3>Product Goodon Inventory</h3>
                        	</div>
                        	<div class="col-md-2">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
												<tr>
													...
													<!-- <td><center><input type="checkbox" name="productid[]" id="productid" value="<?php echo $row["id"] ?>"></center></td> -->
													<td><center><input type="number" class="form-control" name="masterquantity[]" id="masterquantity"></center></td>
                                                    <td><input type="number" class="form-control" id="availablequentity" value="<?php echo $row['available_quentity'] ?>" readonly></td>
												</tr>
                                        <?php
                                            }
                                            ?>
