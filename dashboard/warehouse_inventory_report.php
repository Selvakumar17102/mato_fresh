...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>warehouse inventory Reports | Mato Fresh</title>
                    	        ...
                    	        <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
									...
									<tbody>
                                        ...
                                        while($proRow = $proResult->fetch_assoc()){
                                            ...
                                            $sql="SELECT sum(master_quentity) as total FROM `warehouse_inventory_history` WHERE product_id='$proId' AND date BETWEEN '$start' AND '$date'";
...
<script>
	function boss(val)
	{
		if(val != "")
		{
			location.replace("http://mato_fresh.test/dashboard/warehouse_inventory_report.php?id="+val);
		}
	}
	function search()
	{
		...
		else
		{
			...
			{
				location.replace("http://mato_fresh.test/dashboard/warehouse_inventory_report.php?fdate="+fdate+"&tdate="+tdate);
			}
		}
	}
</script>
