...
<head>
	...
	<!-- DESCRIPTION -->
	<meta name="description" content="Closed Orders | Mato Fresh" />
	
	<!-- OG -->
	<meta property="og:title" content="Closed Orders | Mato Fresh" />
	<meta property="og:description" content="Closed Orders | Mato Fresh />
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Dispatched Orders | Mato Fresh</title>
		...
		<div class="container-fluid">
			<div class="row">
						...
						<?php 
							...
							if($rhead["control"] == 0)
							{
								$sql = "SELECT * FROM order_details where product_id = '2' ORDER BY sno DESC";
							}
							else
							{
								$sql = "SELECT * FROM order_details where product_id = '2' AND latitude='$hotelid' ORDER BY sno DESC";
							}
