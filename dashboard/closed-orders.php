...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Closed Orders | Mato Fresh</title>
		...
		<div class="container-fluid">
			<div class="row">
						...
						<?php 
							...
							if($rhead["control"] == 0)
							{
								$sql = "SELECT * FROM order_details where product_id = '3' ORDER BY sno DESC";
							}
							else
							{
								$sql = "SELECT * FROM order_details where product_id = '3' AND latitude='$hotelid' ORDER BY sno DESC";
							}
