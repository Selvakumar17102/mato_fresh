<?php
	...
	if($id){
		...
		if(isset($_POST["submit"])){
            ...
            $updateSql = "UPDATE warehouse_inventory SET available_quentity='$total' WHERE product_id='$id'";
            if($conn->query($updateSql)===TRUE){
                $insertSql = "INSERT INTO wastage_inventory (product_id,old_available_quantity,wastage_quantity,created_date)VALUES('$id','$availablequentity','$wastagequentity','$date')";
                if($conn->query($insertSql)===TRUE){
				    header("Location: warehouse_inventory_list.php?msg=Wastage Inventory Updated!");
			    }
            }
		}
...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Warehouse Wastage Inventory | Mato Fresh</title>
						...
						<div class="widget-inner">
                            <div class="form-group row">
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" name="availablequentity" class="form-control" value="<?php echo $availablity.' kg';?>" readonly>
                                </div>
                                <?php
                                if($availablity > 0){
                                    ?>
