<?php
	...
	if(isset($_POST["add"]))
	{
		...
		$sql1 = "INSERT INTO offer_product (oid,name,image,demo,amo,vari,qua) VALUES ('$id','$name','$image','$demo','$amo','$vari','$qua')";
		if($conn->query($sql1) === TRUE)
		{
			header("Location: offer-product.php?id=$id&msg=Product Added!");
		}
    }
?>
<!DOCTYPE html>
						...
						<div class="widget-inner">
							<form class="edit-profile" method="post" enctype="multipart/form-data">
								<div class="">
									...
									<div class="form-group row">
										<div class="col-sm-6">
											<input type="text" name="vari" class="form-control" required placeholder="Variation">
										</div>
										<div class="col-sm-6">
						...
						<div class="widget-inner">
                            <div class="table-responsive">
                    	        <table id="dataTableExample1" class="table table-striped">
									...
									<tbody>
										<?php
											$sql = "SELECT * FROM offer_product WHERE oid='$id' ORDER BY name ASC";
											$result = $conn->query($sql);
											$count = 1;
										...
										?>
												<tr>
													...
													<td><center><?php echo $row["vari"] ?></center></td>
													<td><center><?php echo number_format($row["qua"]) ?></center></td>
													<td><center>
														<table style="width:100px">
															<tr>
																<td style="border: none !important">
																	<a href="edit-oproduct.php?id=<?php echo $row["id"] ?>"><img src="assets/images/icons/edit.svg" alt=""></a>
																</td>
																<td style="border: none !important">
																	<a onClick="return confirm('Sure to Delete this Product!');" href="delete-oproduct.php?id=<?php echo $row["id"] ?>"><img src="assets/images/icons/delete.svg" alt=""></a>
																</td>
															</tr>
														</table>
                                                    </center></td>
