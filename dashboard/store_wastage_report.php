...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>store Wastage Reports | Mato Fresh</title>
                    	        ...
                    	        <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
									...
									<tbody>
                                        ...
                                        while($proRow = $proResult->fetch_assoc()){
                                            ...
                                            $sql="SELECT sum(wastage_quantity) as total FROM `store_wastage_inventory` WHERE product_id='$proId' AND created_date BETWEEN '$start' AND '$date'";
...
<script>
	function boss(val)
	{
		if(val != "")
		{
			location.replace("http://mato_fresh.test/dashboard/store_wastage_report.php?id="+val);
		}
	}
	function search()
	{
		...
		else
		{
			...
			{
				location.replace("http://mato_fresh.test/dashboard/store_wastage_report.php?fdate="+fdate+"&tdate="+tdate);
			}
		}
	}
</script>
