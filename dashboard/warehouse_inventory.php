...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Warehouse Inventory | Mato Fresh</title>
						...
						<div class="widget-inner">
							<div class="table-responsive">
                                <table id="" class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                            $sql = "SELECT * FROM `product` a LEFT OUTER JOIN warehouse_inventory b ON a.id=b.product_id WHERE a.status = '1'";
                                            $result = $conn->query($sql);
                                            $count = 0;
                                            while($row = $result->fetch_assoc())
                                            {
                                        ...
                                        ?>
												<tr>
                                                    ...
                                                    <td><input type="text" class="form-control" id="availablequentity" value="<?php if($row['available_quentity'] != NULL){ echo $row['available_quentity'].' kg';}else{ echo '0 kg';} ?>" readonly></td>
												</tr>
                                        <?php
                                            }
                                            ?>
