<?php
	...
	$sql1 = "SELECT * FROM hotel WHERE lid='$ids'";
                    	        ...
                    	        <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
									...
									<tbody>
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM order_details WHERE latitude='$wid' AND product_id ='3' AND booking_date BETWEEN '$start' AND '$date' ORDER BY sno DESC";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><center><a href="view-order.php?id=<?php echo $row["sno"] ?>"><?php echo $row["orderid"] ?></a></center></td>
                                                <td><center>Rs <?php echo number_format($row["overall_total_amount"]) ?></center></td>
...
<script>
	function boss(val)
	{
		if(val != "")
		{
			location.replace("https://matofresh.in/dashboard/hotel-report.php?ids=<?php echo $ids."&" ?>id="+val);
		}
	}
	function search()
	{
		...
		else
		{
			...
			{
				location.replace("https://matofresh.in/dashboard/hotel-report.php?ids=<?php echo $ids."&" ?>fdate="+fdate+"&tdate="+tdate);
			}
		}
	}
</script>
