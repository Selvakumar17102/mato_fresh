<?php
    ...
    if(!empty($data->user_id))
    {
        ...
        $sql = "SELECT * FROM order_details WHERE latitude='$user_id' AND product_id !='3' AND order_status!='Cancelled' ORDER BY sno DESC";
        ...
        if($result->num_rows > 0)
        {
            while($row = $result->fetch_assoc())
            {
                ...
                $sql4 = "SELECT * FROM order_details WHERE latitude='$user_id' AND product_id !='3' AND order_status!='Cancelled' AND username='$username'";
                $result4 = $conn->query($sql4);
