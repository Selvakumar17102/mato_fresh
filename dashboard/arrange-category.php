	...
	if(isset($_POST["submit"]))
	{
		...
		if(count($results) == count($_POST["arrange"]))
		{
			for($i=0;$i<$count;$i++)
			{
				...
				$sql = "UPDATE category SET arrange='$arrange' WHERE id='$id'";
				if($conn->query($sql) === TRUE)
				{
					header("Location: add-category.php?msg=Arrangement updated!");		
				}
			}
		}
		else
		{
			// echo $hid;
			header("Location: arrange-category.php?msg=Duplicate values detected!");
		}
	}
?>
<!DOCTYPE html>
                ...
                <div class="col-sm-12">
                    <div class="widget-box">
                        ...
                        <div class="widget-inner">
                            ...
                            <?php
                                $sql = "SELECT * FROM category ORDER BY arrange,name ASC";
