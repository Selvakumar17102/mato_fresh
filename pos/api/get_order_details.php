<?php
    ...
    if(!empty($data->mobile_number))
    {
        ...
        $sql = "SELECT * FROM order_details WHERE mobile_number='$phone' AND payment_status != '' AND payment_status IS NOT NULL AND payment_status != 'Failed' AND payment_status != 'Pending' order by sno desc";
