<?php
    ...
    if(!empty($data->user_id))
    {
        ...
        $sql = "SELECT * FROM order_details WHERE latitude='$user_id' AND product_id='3' AND booking_date BETWEEN '$fromdate' AND '$todate' ORDER BY sno DESC";
        ...
        else
        {
            ...
            $myObj = new \stdClass();
            $myObj->status = "fail";
            $myObj->message = "No Orders Available in the dates.";
