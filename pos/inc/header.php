<?php
    ...
    $shead = "SELECT * FROM pos_login WHERE username='$user'";
    $resulthead = $conn->query($shead);
    $rhead = $resulthead->fetch_assoc();

    $headid = $rhead["id"];
    $store_id = $rhead["store_id"];
    $username = $rhead["username"];
            ...
            <div class="header">
				<!-- Logo -->
				 <div class="header-left border-0 ">
					<a href="posdashboard.php" class="logo logo-normal" style="width:100px">
						<img src="assets/images/logo.png"  alt="">
					</a>
					<a href="posdashboard.php" class="logo logo-white">
						<img src="asset/img/logo-white.png"  alt="">
					</a>
					<a href="posdashboard.php" class="logo-small">
						<img src="assets/images/logo.png" alt="">
					</a>
				</div>
				<!-- /Logo -->
					...
					<li class="nav-item dropdown has-arrow main-drop">
						...
						<div class="dropdown-menu menu-drop-user">
							<div class="profilename">
								...
								<hr class="m-0">
								<a class="dropdown-item logout pb-0" href="logout.php"><img src="asset/img/icons/log-out.svg" class="me-2" alt="img">Logout</a>
							</div>
						</div>
					</li>
				</ul>
